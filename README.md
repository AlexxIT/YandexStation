...
**Внимание**. В тексте часто используются термины локальная колонка, локальный режим и локальное управление (они несут одинаковый смысл). Внимательно изучите, какие колонки его поддерживают. Функции и возможности локального управления сильно превосходят облачное управление. Облачное управление поддерживается на всех устройствах. Локальный режим включается автоматически на поддерживаемых колонках.
...
- [Интеграция с Яндекс.Диалогами](#интеграция-с-яндексдиалогами)
  - [Четвёртый способ вызвать TTS](#четвёртый-способ-вызвать-tts)
...
Из-за зависимости от "Режим звука" - не рекомендуется к использованию в автоматизациях. Используйте первый способ.
...
- только в локальном режиме, используя [четвёртый способ вызвать TTS](#четвёртый-способ-вызвать-tts)
...
- Нужна Яндекс колонка с поддержкой локального управления. Яндекс Модуль функцию НЕ поддерживает.
