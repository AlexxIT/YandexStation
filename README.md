...
**Внимание** с версии 0.1.8 параметры вызова функции изменились!
...
Указание `entity_id` обязательно. Поддерживается указание нескольких станций.
...
Альтернативно послать текст можно следующей командой 

```yaml
script:
  yandex_play:
    alias: Включить видео на Яндекс.Станции
    sequence:
    - service: media_player.play_media
      data:
        entity_id: media_player.yandex_station_12345678901234567890
        media_content_id: Включи видосики про котиков
