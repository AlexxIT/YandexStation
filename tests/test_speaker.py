...
def test_song():
    ...
    device = {'name': '', 'quasar_info': {'device_id': '', 'platform': ''}}
    # noinspection PyTypeChecker
    speaker = YandexStation(None, device)
    ...
    assert speaker.media_image_url == "https://avatars.yandex.net/get-music-content/49876/a4be9993.a.4712278-1/400x400"
...
def test_radio():
        ...
        'state': {
            ...
            'playerState': {
                ...
                'entityInfo': {
                    ...
                    'repeatMode': 'None', 'shuffled': False,
                    'type': 'FM_RADIO'
                }, 'extra': {
    ...
    assert speaker.media_image_url == "https://avatars.mds.yandex.net/get-music-misc/28592/europa_plus-225/400x400"
...
def test_youtube():
    ...
    assert speaker.media_image_url == "https://avatars.mds.yandex.net/get-vthumb/3824233/731068d602e061926601848918f20342/800x360"
...
def test_kinopoisk():
    ...
    assert speaker.media_image_url == "https://avatars.mds.yandex.net/get-vh/3371956/4864628686399976456-osdbSmYti8-SnuEJnOQuRg-1589623034/640x360"
    assert speaker.media_position == 93
    assert speaker.media_title == "Смешарики. Новый сезон - Сезон 1 - Серия 1 - Природное свойство"
    assert speaker.state == "playing"
